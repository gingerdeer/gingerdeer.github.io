...
Ez a rövid cikk a GILFs-videojátékomról mesél, az elsõ általam írt játek. Iskolában voltam, a kilencedik osztályban, és egy kurzusba kellett írnunk valamit CoolBasic-cal. A játék egy roguelike-tipus játék, amiben a játékos egy barlangban kutat. Nincs szörny vagy küzdelem, de meg lehet halni a játékos éhségbõl vagy csapdából. Nyílgombokkal vagy számgombokkal lehet játszani. Egy nagyon egyszerű algoritmus van a barlang alkotnire. 

<br><br>
A cikk néhány nyelven olvasható!1!!1 (de finnül a játék :)):<br>  
</div>
...
Nem szép a kód. Imperatívus programozás stílusában írt van. A main-függvény a legnagyobb részet vesz a kódból, de néhány más függvény van is. 
